...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='0', help='source')  # file/folder, 0 for webcam # 검출할 입력데이터 경로
    parser.add_argument('--img-size', type=int, default=640, help='inference size (pixels)') # 신경망에 입력되는 이미지의 크기
    parser.add_argument('--conf-thres', type=float, default=0.8, help='object confidence threshold') # 신뢰도 기준
    ...
    parser.add_argument('--nosave', action='store_true', help='do not save images/videos') # 감지된 이미지 또는 비디오를 저장할지 여부
